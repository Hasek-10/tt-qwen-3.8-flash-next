...
//
// index_tail, rope core compute (16-bit dest, the op's own): RoPE of the normalized query's first two tiles, then per
// lane RoPE of the pooled key's first two tiles with the lane's block-start rows.  Runtime arg 0: rows.
